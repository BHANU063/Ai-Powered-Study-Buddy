...
import { Smiley, Cards, FileText, CheckSquare, MagicWand, Timer, Question, GameController, XCircle, Plus, CheckCircle, Trash, ArrowRight } from '@phosphor-icons/react';
...
export default function Dashboard() {
  ...
  return (
    <div style={{width: '100%'}}>
          ...
          <div style={{
            ...
            <div
              style={{
                ...
                marginBottom: 8,
                boxShadow: '0 0 30px 10px #FFA500, 0 0 60px 20px #FFD59A',
                animation: 'pulse 2s infinite, float 3s ease-in-out infinite, glow 2s infinite',
                position: 'relative',
                overflow: 'hidden',
                filter: 'drop-shadow(0 0 20px #FFA50088) drop-shadow(0 0 40px #FFD59A66)',
                cursor: 'pointer',
              }}
              title="Open StudyBuddy Features"
            >
      ...
      <footer style={{ width: '100%', textAlign: 'center', marginTop: 40, padding: 20, color: '#888', fontSize: 16, borderTop: '1px solid #eee', background: 'rgba(255,255,255,0.7)' }}>
        <div><b>About Us:</b> Bhanu Reddy (1NH23CS044) & Bhavkirat Kaur Kurana (1NH23CS045)</div>
